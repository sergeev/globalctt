...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Edit Student {{ $student->name_1_ot }} {{ $student->surname_1_fam }}</div>

                <div class="card-body">
                    <form action="{{ route('students.students.update', $student) }}" method="POST">

                        <div class="form-group row">
                            <label for="email" class="col-md-2 col-form-label text-md-right">*Номер сертификата ПФДО:</label>
