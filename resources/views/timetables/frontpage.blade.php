...
<div class="container">
  ...
  <body>
    <!-- Begin Bacground  -->
    <div class="jumbotron p-4 p-md-5 text-white" style="background-image: url('images/kvantum/energy/energy-p.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
      <div class="col-md-6 px-0">
        <h1 class="my-0 font-weight-big"><font color="#385E9D">РАСПИСАНИЕ</font></h1>
      </div>
    </div>

    <!-- End Bacground -->
    <!-- Begin enter group kvantum -->
    <!-- end enter group kvantum -->
    <div class="card-deck mb-3 text-center">
      <div class="card mb-4 box-shadow">
        <div class="card-header" style="background-color: #385E9D;">
          <h4 class="my-0 font-weight-normal"><font color="white">РАСПИСАНИЕ ЗАНЯТИЙ:</font></h4>
        </div>
                ...
                <div class="tab-pane fade" id="it" role="tabpanel" aria-labelledby="it">
                  <div class="table-responsive">
                    <table class="table table-striped table-bordered table-light">
                      ...
                      <tbody>
                        <tr>
                          <th scope="row">iuy876876876768</th>
                          <td></td>
                          <td></td>
                          <td><p>1 гр.
                            <p>09.00-09.40</p>
