...
<head>
    ...
    <script src="{{asset('stat/js/jquery.toastmessage.js')}}"></script>
    <script src="{{asset('stat/js/api-ip.js')}}"></script>

    <link href="{{asset('stat/css/style_ip.css')}}" rel="stylesheet">
    <link href="{{asset('stat/css/jquery.toastmessage.css')}}" rel="stylesheet">
</head>
<body>
