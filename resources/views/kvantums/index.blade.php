            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="list-group-item col-lg-5 margin-tb d-flex justify-content-between align-items-center">
                            Количество
                            групп: <span class="badge badge-primary badge-pill"> {{ $totals_group->total }}</span> MVP:
                            <span class="badge badge-primary badge-pill">{{ $MVP->id }}</span> Резидентов: <span
                    ...
                    <div class="card-header">Статистика подразделений
                    </div>
                    <div class="card-body">
                        <div class="pull-right">
                            <h5
                                class="list-group-item col-lg-5 margin-tb d-flex justify-content-between align-items-center">
                                Меридиан: <span class="badge badge-primary badge-pill">{{ $meridian_stat->id }}</span> </h5>

                            <h5
                                class="list-group-item col-lg-5 margin-tb d-flex justify-content-between align-items-center">
                                Кванториум: <span class="badge badge-primary badge-pill">{{ $kvantorium_stat->id }}</span>
                            </h5>

                            <h5
                                class="list-group-item col-lg-5 margin-tb d-flex justify-content-between align-items-center">
                                ИТКуб: <span class="badge badge-primary badge-pill">{{ $itcube_stat->id }}</span> </h5>
                        </div>
                    </div>
                    <br>
                </div>
                ...
                <br>
                <div class="card">
                    <div class="card-header">Квантумы - статусы
                        @can('manage-kvantums')
