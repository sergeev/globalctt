...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Редактирование Квантума {{ $kvantum->kvantum_name }}
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('kvantum_id', null, array('placeholder' => '0','class' =>
                                'form-control')) !!}
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                'Количество человек в 1
                                группе','class' => 'form-control')) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('kvantum_desc', null, array('placeholder' => 'Описание
                                квантума','class' =>
                                'form-control')) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::select('kvantum_status', ['0' => 'Квантум закрыт', '1' => 'Квантум открыт'],
                                null, ['class' =>
                                'form-control']) !!}
                            </div>
                        </div>
